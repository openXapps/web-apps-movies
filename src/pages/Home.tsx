...
import { TmdbMoviesData } from '@/lib/types';
import { getMovies } from '@/lib/api';

export default function Home() {
  const movies = useLoaderData() as TmdbMoviesData;
...
export function loaderTrending() {
  return getMovies('trending');
}

export function loaderOnDvD() {
  return getMovies('ondvd');
}

export function loaderFavourites() {
  return getMovies('favourites');
}