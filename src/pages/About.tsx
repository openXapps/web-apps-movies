...
export default function About({ routeId }: { routeId: number }) {
  ...
  return (
    <div className='m-6 flex gap-6 flex-col place-items-center text-center text-xl'>
      <p>This movies information web app <span>{`(v${version})`}</span> is a pet project, built by me, a person who loves developing in React as a hobby. The source code of this project can be found on <span><a className='text-orange-400' href="https://github.com/openXapps/web-apps-movies" target='_blank' rel="noopener noreferrer">GitHub</a></span>.</p>
